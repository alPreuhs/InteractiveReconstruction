...
class Ui_ReconstructionGUI(object):
    def setupUi(self, ReconstructionGUI):
        ...
        self.gridLayout.addWidget(self.gV_Backproj, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_Backproj, 0, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_BackprojFFT, 6, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.gV_Backproj_FFT, 7, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.pB_Reconstruction, 1, 5, 7, 1)

...
class Ui_ReconstructionGUI(object):
    def setupUi(self, ReconstructionGUI):
        ...
        ReconstructionGUI.resize(1120, 707)
        ...
        self.groupBox.setMaximumSize(QtCore.QSize(16777215, 152))
        ...
        self.bt_start_simulation = QtWidgets.QPushButton(self.frame_10)
        self.bt_start_simulation.setObjectName("bt_start_simulation")
        self.gridLayout.addWidget(self.bt_start_simulation, 0, 1, 1, 1)
        self.bt_stop_simulation = QtWidgets.QPushButton(self.frame_10)
        self.bt_stop_simulation.setObjectName("bt_stop_simulation")
        self.gridLayout.addWidget(self.bt_stop_simulation, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.hScrollBar_maxbeta, 5, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_delta_2, 4, 1, 1, 2)
        ...
        self.sl_maxT = QtWidgets.QSlider(self.frame_8)
        self.sl_maxT.setMinimum(1)
        self.sl_maxT.setMaximum(100)
        self.sl_maxT.setProperty("value", 50)
        self.sl_maxT.setOrientation(QtCore.Qt.Vertical)
        self.sl_maxT.setObjectName("sl_maxT")
        self.verticalLayout_6.addWidget(self.sl_maxT)
        self.horizontalLayout_3.addWidget(self.frame_8)
        self.groupBox_2 = QtWidgets.QGroupBox(self.groupBox)
        self.groupBox_2.setObjectName("groupBox_2")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox_2)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.checkBox_RamLakFilter = QtWidgets.QCheckBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.checkBox_RamLakFilter.setFont(font)
        self.checkBox_RamLakFilter.setObjectName("checkBox_RamLakFilter")
        self.gridLayout_3.addWidget(self.checkBox_RamLakFilter, 0, 1, 1, 1)
        self.checkBox_ParkerWeigh = QtWidgets.QCheckBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.checkBox_ParkerWeigh.setFont(font)
        self.checkBox_ParkerWeigh.setObjectName("checkBox_ParkerWeigh")
        self.gridLayout_3.addWidget(self.checkBox_ParkerWeigh, 0, 0, 1, 1)
        self.checkBox_cosine = QtWidgets.QCheckBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.checkBox_cosine.setFont(font)
        self.checkBox_cosine.setObjectName("checkBox_cosine")
        self.gridLayout_3.addWidget(self.checkBox_cosine, 0, 2, 1, 1)
        self.checkBox_derivative = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_derivative.setObjectName("checkBox_derivative")
        self.gridLayout_3.addWidget(self.checkBox_derivative, 1, 0, 1, 1)
        self.checkBox_hilbert = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_hilbert.setObjectName("checkBox_hilbert")
        self.gridLayout_3.addWidget(self.checkBox_hilbert, 1, 1, 1, 1)
    ...
    def retranslateUi(self, ReconstructionGUI):
        ...
        self.checkBox_RamLakFilter.setText(_translate("ReconstructionGUI", "RamLak"))
        self.checkBox_ParkerWeigh.setText(_translate("ReconstructionGUI", "Parker"))
        self.checkBox_cosine.setText(_translate("ReconstructionGUI", "Kosinus"))
        self.checkBox_derivative.setText(_translate("ReconstructionGUI", "Derivative"))
        self.checkBox_hilbert.setText(_translate("ReconstructionGUI", "Hilbert"))

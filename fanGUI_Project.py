...
class Ui_ReconstructionGUI(object):
    def setupUi(self, ReconstructionGUI):
        ...
        self.horizontalLayout_4.addWidget(self.checkBox_ParkerWeigh)
        ...
        self.horizontalLayout_4.addWidget(self.checkBox_RamLakFilter)
        ...
        self.horizontalLayout_4.addWidget(self.checkBox_cosine)
